    ...
    <div class="content">
      <div class="subsection">
        <table style="margin-top: 3%; margin-bottom: 10%">
            <span class="subsection-title">List of Inpatients</span>
            <br>
            ...
            <tr v-for="(patients, index) in patients">
				<td class="patient-info">{{patients.admitted_datetime}}</td>
                <td class="patient-name">{{ patients.patientname }}</td>
...
export default {
  ...
  methods: {
    getPatients () {
      return axios.get('/api/inpatients')
        .then((res) => {
